...
export default function Whitepaper() {
  const ItemList = [
    ...
    {
      thumbImage:
        'https://images.pexels.com/photos/3873177/pexels-photo-3873177.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500',
      title: '비타민D는 코로나 치료에 효과가 있나?',
      content:
        '하이드록시클로로퀸, 구충제 이버멕틴, 비타민D 등이 코로나19 치료법으로 거론됐다.임상시험이 완료되기 전에 특정 치료법의 긍정적인 효과를 제안하는 건 가능한 일이다. 물론 효과를 기대했다가 임상시험 결과가 이에 못 미치는 경우도 많다. 하지만 인터넷에서는 치료법에 대한 임상 시험 초기 결과나 아직 완성되지 않은 연구 결과가 무분별하게 퍼질 수 있다.',
    },
  ]
