      ...
      <div className={'container py-12 px-6 lg:px-0 lg:py-16'}>
        ...
        <div>
          ...
          <div className="mb-8">
            ...
            <p>
              회사는 수집한 개인정보를 다음의 목적을 위해 개인정보를 처리하고 있으며, 다음의 목적 이외의 용도로는
              이용하지 않습니다.
            </p>
          ...
          <div className="mb-8">
            ...
            <h3 className="text-base font-extrabold pt-4">
              가. 회사 내부방침에 의한 정보보유 사유 회원이 탈퇴한 경우에도 불량회원의 부정한 이용의 재발을 방지,
              분쟁해결 및 수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터 3년간 회원의 정보를 보유할 수
              있습니다.
            </h3>
            <h3 className="text-base font-extrabold pt-4">
            ...
            <ol className="leading-7 py-6">
              ...
              <li className="py-2">
                대금 결제 및 재화 등의 공급에 관한 기록 -보존이유: 전자상거래 등에서의 소비자보호에한 법률 -보존기간:
                5년
              </li>
              <li className="py-2">
                소비자 불만 또는 분쟁처리에 관한 기록 -보존이유: 전자상거래 등에서의 소비자보호에 관한 법률 -보존기간:
                3년
              </li>
          ...
          <div className="mb-8">
            ...
            <ol className="leading-7">
              ...
              <li>
                개인정보의 오류에 대한 정정을 요청하신 경우에는 정정을 완료하기 전까지 당해 개인정보를 이용 또는
          ...
          <div className="mb-8">
            ...
            <p className="pt-4">
              웹브라우저에서 옵션을 설정함으로써 모든 쿠키를 허용하거나, 쿠키가 저장될 때마다 확인을 거치거나, 아니면
            ...
            <ol className="leading-7 pt-4">
              ...
              <li>
                설정방법 예(인터넷 익스플로어의 경우): 웹 브라우저 상단의 도구 > 인터넷 옵션 > 개인정보메뉴의 옵션
                설정을 통해 쿠키 저장을 거부 할 수 있습니다. 단, 쿠키 설치를 거부하였을 경우 맞춤형 서비스 제공에
                어려움이 발생 할 수 있습니다.
              </li>
            </ol>
          </div>
          ...
          <div className="mb-8">
            ...
            <p>
              이 개인정보처리방침은 2021년 0월 0일부터 적용됩니다. 현 개인정보처리방침이 회사 또는 정부의 정책,
              보안기술의 변경에 따라 내용의 추가, 삭제 및 변경이 있을 경우, 회사는 변경사항의 시행 7일 전부터 인터넷
              홈페이지, 어플리케이션의 '공지사항'을 통해 고지할 것입니다. 변경된 개인정보처리방침은 변경 고지한 날로부터
              7일 후부터 효력이 발생합니다. 이전의 개인정보처리방침은 아래에서 확인하실 수 있습니다.
            </p>
          </div>
        </div>
      </div>
